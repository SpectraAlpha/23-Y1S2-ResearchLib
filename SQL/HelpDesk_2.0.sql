...
--Run the whole Sql query as a batch
GO
...
(
	...
	-- On delete : of the original record in the Staff_Role table the FKey is set to null
	-- On update : Record in the Staff_Role tb is also updated
);
