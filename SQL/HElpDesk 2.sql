...
(
    ...
    CONSTRAINT Staff_Role_FK FOREIGN KEY(Role) REFERENCES Staff_Role(Role_ID)
);
...
(
    ...
    CONSTRAINT SPN_FK FOREIGN KEY(Staff_ID) REFERENCES Staff(Staff_ID)
);
...
(
    ...
    CONSTRAINT Issue_Priority_FK FOREIGN KEY(Priority) REFERENCES Priority(ID)
);
...
(
    ...
    Issue_ID VARCHAR(65) DEFAULT NULL,
    Feedback_ID VARCHAR(65) DEFAULT NULL,
    CONSTRAINT Ticket_PK PRIMARY KEY(Ticket_ID),
    CONSTRAINT Ticket_Student_FK FOREIGN KEY(Student_ID) REFERENCES Student(Student_ID),
    CONSTRAINT Ticket_Staff_FK FOREIGN KEY(Staff_ID) REFERENCES Staff(Staff_ID),
    CONSTRAINT Ticket_Feedback_FK FOREIGN KEY(Feedback_ID) REFERENCES Feedback(Feedback_ID),
    CONSTRAINT Ticket_Issue_FK FOREIGN KEY(Issue_ID) REFERENCES Issue(Issue_ID),
    CONSTRAINT Ticket_FoI_ID_Chk CHECK(Issue_ID IS NOT NULL OR Feedback_ID IS NOT NULL)
);

CREATE TABLE Issue_Solution
(
    Ticket_ID VARCHAR(65) NOT NULL,
    Issue_ID VARCHAR(65) NOT NULL,
    Solution VARCHAR(800) DEFAULT NULL,
    CONSTRAINT ISolution_Ticket_FK FOREIGN KEY(Ticket_ID) REFERENCES Ticket(Ticket_ID),
    CONSTRAINT ISolution_Issue_FK FOREIGN KEY(Issue_ID) REFERENCES Issue(Issue_ID),
    CONSTRAINT ISolution_PK PRIMARY KEY(Ticket_ID, Issue_ID)
);
...
(
    Ticket_ID VARCHAR(65) NOT NULL,
    Feedback_ID VARCHAR(65) NOT NULL,
    Reply VARCHAR(800) DEFAULT NULL,
    CONSTRAINT FReply_Ticket_FK FOREIGN KEY(Ticket_ID) REFERENCES Ticket(Ticket_ID),
    CONSTRAINT FReply_PK PRIMARY KEY(Ticket_ID, Feedback_ID),
    CONSTRAINT FReply_Issue_FK FOREIGN KEY(Feedback_ID) REFERENCES Feedback(Feedback_ID)
);
...
(
    ...
    Started_By VARCHAR(10) NOT NULL,
    ...
    CONSTRAINT TTopic_Student_FK FOREIGN KEY(Started_By) REFERENCES Student(Student_ID),
    CONSTRAINT TTopic_Staff_FK FOREIGN KEY(Started_By) REFERENCES Staff(Staff_ID),
    CONSTRAINT TTopic_Staff_Auth_FK FOREIGN KEY(Authorized_By) REFERENCES Staff(Staff_ID),
    CONSTRAINT TTopic_Category_FK FOREIGN KEY(Category) REFERENCES Thread_Category(Category_ID)
);
...
(
    ...
    Rating INT DEFAULT 0 NOT NULL,
    CONSTRAINT TReply_TTopic_FK FOREIGN KEY(Topic_ID) REFERENCES Thread_Topic(Topic_ID),
    CONSTRAINT TReply_PK PRIMARY KEY(Topic_ID, Reply_ID),
    CONSTRAINT TReply_Student_FK FOREIGN KEY(Author_ID) REFERENCES Student(Student_ID),
    CONSTRAINT TReply_Staff_FK FOREIGN KEY(Author_ID) REFERENCES Staff(Staff_ID)
);
...
(
    ...
    CONSTRAINT KB_Staff_FK FOREIGN KEY(Author_ID) REFERENCES Staff(Staff_ID),
    CONSTRAINT KB_Category_FK FOREIGN KEY(Category) REFERENCES Knowledge_Base_Category(Category_ID)
);
...
(
    ...
    CONSTRAINT KB_Attachment_FK FOREIGN KEY(KB_ID) REFERENCES Knowledge_Base(KB_ID),
...
(
    ...
    CONSTRAINT Call_Student_FK FOREIGN KEY(Student_ID) REFERENCES Student(Student_ID),
    CONSTRAINT Call_Hotline_FK FOREIGN KEY(Hotline_Number) REFERENCES Hotline(Hotline_Number),
    CONSTRAINT Call_Staff_FK FOREIGN KEY(Staff_ID) REFERENCES Staff(Staff_ID)
);
...
GO
CREATE TRIGGER TRG_Thread_Reply ON Thread_Reply INSTEAD OF INSERT AS
BEGIN
    DECLARE @T_ID INT
    DECLARE @R_ID INT
    ...
    INSERT INTO Thread_Reply
        (Topic_ID, Reply_ID, Author_ID, Comment)
    VALUES
        (@T_ID, @R_ID, @A_ID, @C)
END
...
INSERT INTO Ticket
    (Student_ID, Staff_ID, Date_Created, Date_Closed, Issue_ID, Feedback_ID)
VALUES
    ('AB12345678', 'CD98765432', '2023-03-12 09:23:45', NULL, NULL, 'F100'),
    ('EF54321098', 'GH67890123', '2023-04-15 14:30:10', '2023-04-17 11:45:20', 'I100', NULL),
    ('IJ34567890', 'KL90123456', '2023-05-02 16:55:30', '2023-05-04 08:20:15', NULL, 'F101'),
    ('MN56789012', 'OP12345678', '2023-03-28 10:10:20', NULL, 'I101', NULL),
    ('QR09876543', 'ST65432109', '2023-04-19 12:35:45', '2023-04-20 09:10:55', NULL, 'F102'),
    ('AB12345678', 'GH67890123', '2023-05-10 15:45:30', NULL, NULL, 'F103'),
    ('CD98765432', 'KL90123456', '2023-03-15 08:20:40', '2023-03-17 13:05:25', 'I102', NULL),
    ('EF54321098', 'OP12345678', '2023-04-05 11:30:15', NULL, 'I103', NULL),
    ('GH67890123', 'ST65432109', '2023-05-06 13:15:55', '2023-05-09 10:40:10', NULL, 'F104'),
    ('IJ34567890', 'CD98765432', '2023-03-22 09:55:20', '2023-03-24 14:25:30', NULL, 'F105'),
    ('AB12345678', 'AB12345678', '2023-05-19 09:00:00', '2023-05-19 10:30:00', 'I104', NULL),
    ('CD98765432', 'CD98765432', '2023-05-19 10:15:00', NULL, NULL, 'F106'),
    ('EF54321098', 'EF54321098', '2023-05-19 11:30:00', NULL, NULL, 'F107'),
    ('GH67890123', 'GH67890123', '2023-05-19 12:45:00', '2023-05-19 13:30:00', 'I105', NULL),
    ('IJ34567890', 'IJ34567890', '2023-05-19 13:15:00', NULL, 'I106', NULL),
    ('KL90123456', 'KL90123456', '2023-05-19 14:30:00', '2023-05-19 15:00:00', NULL, 'F108'),
    ('MN56789012', 'MN56789012', '2023-05-19 15:45:00', NULL, 'I107', NULL),
    ('OP12345678', 'OP12345678', '2023-05-19 16:30:00', NULL, NULL, 'F109'),
    ('QR09876543', 'QR09876543', '2023-05-19 17:00:00', '2023-05-19 18:15:00', 'I108', NULL),
    ('ST65432109', 'ST65432109', '2023-05-19 18:45:00', '2023-05-19 19:30:00', 'I109', NULL);
...
VALUES
    ('AB12345678', 'CD98765432', 'Need help with course registration', 'I''m having trouble registering for my courses. Can someone assist me?', 1),
    ('CD98765432', 'EF54321098', 'Trouble accessing online resources', 'I''m unable to access the online library and other resources. Any suggestions?', 2),
    ('EF54321098', 'GH67890123', 'Query regarding assignment deadline', 'I have a question about the deadline for the upcoming assignment. Can someone clarify?', 3),
    ('GH67890123', 'IJ34567890', 'Seeking guidance on research topic', 'I''m looking for guidance in choosing a research topic for my dissertation. Any recommendations?', 4),
    ('IJ34567890', 'KL90123456', 'Lost student ID card', 'I''ve lost my student ID card. What should I do?', 5),
    ('KL90123456', 'MN56789012', 'Recommendations for part-time jobs', 'I''m looking for part-time job opportunities near the campus. Any recommendations?', 6),
    ('MN56789012', 'OP12345678', 'Course material not accessible', 'I''m unable to access the course materials on the learning management system. Can someone help?', 7),
    ('OP12345678', 'QR09876543', 'Request for course transfer', 'I would like to request a transfer to a different course. How can I proceed?', 8),
    ('QR09876543', 'ST65432109', 'Concerns regarding lecture timings', 'I have some concerns regarding the timing of one of my lectures. Can I discuss this with someone?', 9),
    ('ST65432109', 'AB12345678', 'Need assistance with study schedule', 'I need help in creating an effective study schedule. Any tips?', 10);
...
INSERT INTO Thread_Reply
    (Topic_ID, Author_ID, Comment)
VALUES
    (1, 'AB12345678', 'I can help you with course registration. Please provide me with more details.'),
    (1, 'CD98765432', 'I also faced some issues with course registration before. Let me share my experience.'),
    (1, 'EF54321098', 'If you need any assistance, feel free to ask. I''m here to help.'),
    (2, 'CD98765432', 'To access online resources, try clearing your browser cache and cookies.'),
    (2, 'GH67890123', 'You can also try accessing the resources using a different web browser.'),
    (3, 'EF54321098', 'The assignment deadline is mentioned in the course syllabus. Have you checked it?'),
    (4, 'IJ34567890', 'Choosing a research topic can be challenging. What are your areas of interest?'),
    (4, 'KL90123456', 'Consider exploring recent publications and attending research seminars for inspiration.'),
    (5, 'KL90123456', 'You should report the loss of your student ID card to the university administration.'),
    (6, 'MN56789012', 'Check the job listings board on the campus website for part-time job opportunities.'),
    (6, 'OP12345678', 'Networking with fellow students and alumni can also help in finding part-time jobs.'),
    (7, 'OP12345678', 'Please contact the IT department for assistance with accessing course materials.'),
    (8, 'QR09876543', 'To request a course transfer, you should reach out to the academic advising office.'),
    (8, 'ST65432109', 'Make sure to review the course transfer policy before proceeding.'),
    (9, 'QR09876543', 'You can discuss your concerns regarding lecture timings with your course instructor.'),
    (10, 'AB12345678', 'Creating a study schedule involves setting specific goals and allocating time for each subject.'),
    (10, 'ST65432109', 'Consider using study apps or online tools to help you manage your study schedule.');
...
VALUES
    ('2023-05-19 09:30:00', 94111234567, 'AB12345678', '2023-05-19 09:45:00', 94111234567, 'CD98765432', 'Need assistance with course selection'),
    ('2023-05-19 10:00:00', 94112345678, 'CD98765432', '2023-05-19 10:15:00', 94112345678, 'EF54321098', 'Troubleshooting network connectivity issue'),
    ('2023-05-19 11:30:00', 94113456789, 'EF54321098', '2023-05-19 11:45:00', 94113456789, 'GH67890123', 'Inquiring about scholarship opportunities'),
    ('2023-05-19 12:00:00', 94114567890, 'GH67890123', NULL, 94114567890, 'IJ34567890', 'Seeking advice on study techniques'),
    ('2023-05-19 13:30:00', 94115678901, 'IJ34567890', '2023-05-19 13:45:00', 94115678901, 'KL90123456', 'Requesting information on campus housing'),
    ('2023-05-19 14:00:00', 94111234567, 'AB12345678', NULL, 94111234567, 'MN56789012', 'Enrollment verification request'),
    ('2023-05-19 14:30:00', 94112345678, 'CD98765432', NULL, 94112345678, 'OP12345678', 'Question regarding course prerequisites'),
    ('2023-05-19 15:00:00', 94113456789, 'EF54321098', NULL, 94113456789, 'QR09876543', 'Financial aid eligibility inquiry'),
    ('2023-05-19 15:30:00', 94114567890, 'GH67890123', '2023-05-19 15:45:00', 94114567890, 'ST65432109', 'Concerns about class scheduling'),
    ('2023-05-19 16:00:00', 94115678901, 'IJ34567890', '2023-05-19 16:15:00', 94115678901, 'AB12345678', 'Requesting help with library resources'),
    ('2023-05-19 16:30:00', 94111234567, 'AB12345678', '2023-05-19 16:45:00', 94111234567, 'CD98765432', 'Issue with student portal login'),
    ('2023-05-19 17:00:00', 94112345678, 'CD98765432', NULL, 94112345678, 'EF54321098', 'Inquiring about internship opportunities'),
    ('2023-05-19 17:30:00', 94113456789, 'EF54321098', NULL, 94113456789, 'GH67890123', 'Requesting assistance with course materials'),
    ('2023-05-19 18:00:00', 94114567890, 'GH67890123', '2023-05-19 18:15:00', 94114567890, 'IJ34567890', 'Concerns about academic probation'),
    ('2023-05-19 18:30:00', 94115678901, 'IJ34567890', NULL, 94115678901, 'KL90123456', 'Requesting guidance on career planning'),
    ('2023-05-19 19:00:00', 94111234567, 'AB12345678', '2023-05-19 19:15:00', 94111234567, 'MN56789012', 'Reporting an issue with campus facilities'),
    ('2023-05-19 19:30:00', 94112345678, 'CD98765432', NULL, 94112345678, 'OP12345678', 'Requesting information on student clubs and organizations'),
    ('2023-05-19 20:00:00', 94113456789, 'EF54321098', NULL, 94113456789, 'QR09876543', 'Inquiring about study abroad programs'),
    ('2023-05-19 20:30:00', 94114567890, 'GH67890123', '2023-05-19 20:45:00', 94114567890, 'ST65432109', 'Question regarding graduation requirements'),
    ('2023-05-19 21:00:00', 94115678901, 'IJ34567890', NULL, 94115678901, 'AB12345678', 'Requesting assistance with course registration');
